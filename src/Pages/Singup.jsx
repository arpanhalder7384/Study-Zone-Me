...
export default function Singup() {
  return (
    <div className="h-screen w-screen flex flex-row justify-evenly ">
      <div className="justify-center items-center flex flex-col w-[50%] h-full bg-gray-50 overflow-x-auto overflow-y-auto">
        <div className='flex flex-col w-full justify-center items-center px-[10%] '>
          <div className='justify-center items-center flex flex-col'>
            <h1 class="animate-text mb-[4%] bg-gradient-to-tr from-blue-700 via-purple-500 to-orange-500 bg-clip-text text-5xl font-black text-transparent">Welcome to Study Zone</h1>
            <p className='text-4xl mb-[2%] text-blue-600'>Create Your Account</p>
          </div>
            ...
            <form className="w-full p-4">
              ...
              <div className="m-5 flex justify-center">
                <div className="flex h-5 items-center">
                  <input id="remember" type="checkbox" value="" className="focus:ring-3 h-4 w-4 rounded border border-gray-300 focus:ring-blue-300" required />
                </div>
      ...
      <div className="justify-center items-center w-[50%]">
        ...
        <img src={illustration} className='h-full w-full' />
      </div>
