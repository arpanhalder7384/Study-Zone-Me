          ...
          <div className='flex mt-10  '>
            <form className="w-full">
              ...
              <div className='flex flex-col justify-center w-full'>
                <button type="submit" className="w-full h-12 rounded-lg bg-violet-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto">Log in</button>
              </div>
